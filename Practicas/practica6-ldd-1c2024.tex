...
\item \label{ej:comprehension}
Crear un subconjunto de los datos de \lstinline{penguins} sólo con las obsevaciones de ping\"uinos machos con aletas (flipper) de más de 200 mm de largo y quedarse con todas las columnas que terminan con “mm”.
    
Sugerencias: 
\begin{itemize}
\item \lstinline{penguins.columns} nos devuelve una lista con los nombres de las columnas.
...
reemplazando \lstinline{???} por la condición. Esta forma de definir una lista se conoce como \emph{list comprehension} (definir una lista por comprensión).
