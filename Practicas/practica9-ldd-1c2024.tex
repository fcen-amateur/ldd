...
\vskip 0.2cm
 ...
 \bigskip
 \centerline{\bf Práctica N$^\circ$ 9: Descenso por gradiente}
 \bigskip
...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \begin{enumerate}
            ...
            \item $Y = b + w_0\; X^{w_1}$
            \item $Y = b + w\; e^{X}$ 
            \item $Y = b + w_0\; e^{w_1\; X}$
        \end{enumerate}
        Dividir el conjunto de datos en entrenamiento y testeo y decidir qué modelo resulta más adecuado. Utilizar \verb|scikit-learn| para los modelos lineales y \verb|Regressor| para los no lineales. En este último caso, se pueden usar de guía los modelos lineales para establecer valores iniciales de los pesos. Probar con distintas cantidades de épocas y valores iniciales para los pesos y el bias.
