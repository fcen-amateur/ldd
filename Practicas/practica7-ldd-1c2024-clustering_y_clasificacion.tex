...
\vskip 0.2cm
 ...
 \bigskip
 \centerline{\bf Práctica N$^\circ$ 7: Clustering y clasificación.}
 \bigskip
...
\item
Implementar un clasificador de k-NN que prediga el sexo de los ping\"uinos utilizando como variables a el largo del pico y el largo de la aleta. Hacerlo para diferentes valores de k (impares) y evaluar el error de predicción en cada caso. ¿Cómo elegiría el valor de k óptimo?

\item
Implementar un clasificador de k-NN que prediga la especie de los ping\"uinos. Pueden elegir las variables. ¿Con cuáles variables obtienen mejores resultados?
