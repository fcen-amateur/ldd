...
\begin{enumerate}
	\item Abra cada dataset en Python y genere un diagrama de dispersi\'on para cada uno.
...
%NOTA: OCTAVE solamente produce una salida gr\'afica, no encuentro manera de obtener los puntos que realmente conforman cada cluster.
%
%INCOMPLETO TODAVIA.
