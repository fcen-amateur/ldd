...
\item Utilizando la base de datos de ping\"uinos, completar:

\begin{itemize}
\item Peso promedio de los ping\"uinos de la especie Adelie.
\item Peso promedio de los ping\"uinos de la especie Adelie que viven en la Isla Dream.
\item Para cada isla, el desvío estándar del peso de los pingüinos que viven en esa isla.
\end{itemize}

\item Utilizando las edades de los pacientes que recibió un médico un día, se realiza un boxplot para resumir los datos (utilizando bigotes de longitud hasta 1.5 veces la distancia intercuartil).

Si los datos tienen las siguientes propiedades:
\begin{itemize}
\item Media: 43
\item Mediana: 37
\item Máximo: 100
...
¿Cuál de los cuatro box-plot es el correcto?
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{simu-boxplot1b.png}
        \caption{}
        \label{fig:image1}
    \end{subfigure}
    \hfill
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{simu-boxplot3c.png}
        \caption{}
        \label{fig:image3}
    \end{subfigure}
    \hfill
...
\begin{center}
        \includegraphics[scale=0.8]{simu-moons.png}
\end{center}
...
\item DBSCAN con $\varepsilon = 0.8$ y $minPts = 20$
\end{enumerate}

\item Ingresar un código para generar el siguiente gráfico a partir de datos de Gapminder.

\begin{center}
        \includegraphics[width=\textwidth]{gdpConoSur.png}
\end{center}

Pueden utilizar el siguiente código para cargar los datos de Gapminder.
\begin{lstlisting}
