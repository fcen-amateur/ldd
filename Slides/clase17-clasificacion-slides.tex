...
\begin{frame}
\frametitle{Introducción a la Regresión Logística}
\begin{itemize}
...
\begin{frame}
\frametitle{Características de la Regresión Logística}
\begin{itemize}
    \item \textbf{Interpretación de Coeficientes:}
    \begin{itemize}
        \item Los coeficientes ($\beta_i$) representan el cambio en el logaritmo de las probabilidades (log-odds) por unidad de cambio en el predictor.
    \end{itemize}
    \item \textbf{Bondad del Ajuste:}
    \begin{itemize}
        \item Se utiliza el valor de \textit{p-value} y pruebas como la devianza para evaluar el modelo.
    \end{itemize}
    \item \textbf{Ventajas:}
    \begin{itemize}
        \item Fácil de implementar e interpretar
        \item Escalabilidad para grandes conjuntos de datos
    \end{itemize}
    \item \textbf{Limitaciones:}
    \begin{itemize}
        \item Asume una relación lineal entre los predictores y el log-odds
        \item No funciona bien con datos altamente correlacionados (multicolinealidad)
    \end{itemize}
\end{itemize}
\end{frame}
