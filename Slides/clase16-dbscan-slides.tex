...
\begin{itemize}
\item Dado un conjunto de puntos en algún espacio, se agrupan puntos que están muy juntos (puntos con muchos puntos vecinos).
...
\begin{minipage}{.3\textwidth}
    \begin{center}
    \includegraphics[scale=0.26]{clase16-DBSCAN-illustration.png}
    \end{center}
\end{minipage}
...
\begin{enumerate}
\item Punto \emph{central} $p$, si al menos $minPts$ puntos están a una distancia $\varepsilon$ de $p$ (incluido $p$).
\item Punto \emph{directamente alcanzable} $q$ desde un punto central $p$, si $q$ está a distancia menor o igual que $\varepsilon$ de un punto central $p$.
\item Punto $q$ \emph{alcanzable} desde $p$ si hay un camino $p_1, \dots, p_n$ con $p_1 = p$ y $p_n = q$, donde cada $p_{i+1}$ es directamente alcanzable desde $p_i$.
\item Puntos \emph{atípicos}, todos los puntos que no son alcanzables desde ningún punto central.
\end{enumerate}
\end{minipage}%
\begin{minipage}{.3\textwidth}
...
\item Repetimos el Paso 3 hasta que no hayamos agregado ningún nuevo punto central al cluster.
\end{enumerate}
...
\item \visible<2-> {Añadimos al cluster los 3 puntos directamente alcanzables desde $p$.}
\item \visible<2-> {De estos 3 puntos, solo $q$ es un punto central.}
\item \visible<3-> {Añadimos al cluster los 2 puntos alcanzables desde ese nuevo punto central.}
\item \visible<4-> {No añadimos ningún nuevo punto central, por lo tanto finalizamos.}
\end{enumerate}
...
$\rightarrow$
\begin{tikzpicture}
    \fill[blue] (8,8) circle (2pt);
    \draw[black, thin] (8,8) circle (.5);
    \node[anchor=south] at (8,8) {{\tiny $p$}};
    \fill[blue] (8.2,8.4) circle (2pt);
    \draw[black, thin] (8.2,8.4) circle (.5);
    \fill[blue] (7.8,7.6) circle (2pt);
    \draw[black, thin] (7.8,7.6) circle (.5);
    \node[anchor=south] at (7.8,7.6) {{\tiny $q$}};
    \fill[blue] (8.4,7.8) circle (2pt);
    \draw[black, thin] (8.4,7.8) circle (.5);
    \fill[red] (7.4,7.5) circle (2pt);
    \draw[black, thin] (7.4,7.5) circle (.5);
    \fill[red] (7.9,7.2) circle (2pt);
...
\begin{tikzpicture}
    ...
    \fill[blue] (8.4,7.8) circle (2pt);
    \draw[black, thin] (8.4,7.8) circle (.5);
    \fill[blue] (7.4,7.5) circle (2pt);
    \draw[black, thin] (7.4,7.5) circle (.5);
    \fill[blue] (7.9,7.2) circle (2pt);
    \draw[black, thin] (7.9,7.2) circle (.5);
    \fill[red] (7,7.5) circle (2pt);
    \draw[black, thin] (7,7.5) circle (.5);
    \fill[red] (7,8.2) circle (2pt);
...
{\footnotesize
                ...
                Debilidades:
                    \begin{itemize}[noitemsep,nolistsep]
                        ...
                        \item Desempeño pobre en presencia de outliers
                    \end{itemize}
}
        \end{block}
        ...
        {\footnotesize
                ...
                Fortalezas:
                    \begin{itemize}[noitemsep,nolistsep]
                        ...
                        \item No es necesario especificar el número de clusters
